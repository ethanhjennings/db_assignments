python3 warmup.py simple_dict.json < tests/test_simple.in > tests/test_simple.out
...
python3 warmup.py websters_dict.json < tests/test_websters.in > tests/test_websters.out
